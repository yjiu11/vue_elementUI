<template>
  <el-menu class="navbar topNavebar" mode="horizontal">
    ...
    <div class="right-menu">
      ...
      <el-badge v-model="badge"  class="item" style="float:right;margin:0 25px;">
        <el-tooltip :content="`您有${badge}条消息未读`" effect="light" placement="top" >
