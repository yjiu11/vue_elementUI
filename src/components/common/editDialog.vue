            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                   let params={};
                    ...
                    if(number==0 && this.basicInfo.jgh){
                        params.branchNm = this.branchNm;  //确认批复的时候单独传的机构id
                        params.bankCheckFlag = 1;
                    }
                    this.apiAjax.post(this.basicInfo.btnSrc[number],params).then((res) => {
