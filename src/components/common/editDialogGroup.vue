<template>
  <div class="editDialog">
    <el-dialog v-dialogDrag  :title="dialogTitle" :close-on-click-modal="false" @close="calcel('ruleForm')" :visible.sync="basicInfo.dialogAsync" :width="dialogWidth" :modal-append-to-body="false">
