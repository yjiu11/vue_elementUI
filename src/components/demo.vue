  ...
  <div class="demo">
    ...
    <el-tooltip content="上传图片" placement="top">
      ...
      <el-tooltip content="推送" placement="top">
        <span class="iconfont icon-tuisong" style="font-size:16px;"></span>
      </el-tooltip>
    <br/>
    <br/>
    <div class="clear"></div>
    ...
    <el-upload class="upload-demo" :action="`${apiAjax.getBaseUrl().baseURL}${uploadImg.action}`"  :before-upload="beforeUploadImg" 
...
import editDialogGroup from './common/editDialogGroup' 
    ...
    data() {
      return {
        basicInfo:{
          ...
          // send:true,//让编辑情况下按钮为保存状态，不是新年增状态
          ///////////一下是自定义内容，不写的话，就是单纯的新增修改/////////////////////////////////////////////////
            editDialogTitleAsync:true,//是否定义坦克左上角的文字
            editDialogTitle:"左上角的文字",//自定义弹窗头部名称
            btnAsync:true,//是否定义弹框右下角的按钮
            btnAsyncCancel:true,//右下角取消按钮是否需要，
            btnName:["按钮1","按钮2","按钮3","按钮4"],//右下角按钮个数，和名称
            btnSrc:["caseinfo/update","caseinfo/update","caseinfo/update","caseinfo/update"],//右下角按钮对应的请求路径，同上面的按钮个数要一致
          ///////////////-----自定义内容结束----////////////////////////////////////////////////////////////////
        ...
        basicInfoGroup:{
          ...
          menuName:"分组展示demo",//该菜单名称，只是单纯的新增编辑的时候用的
          currentRow:null,//编辑的时候当前行的数据
          dialogAsync:false,//弹框显示
          isModify:false,//是否是修改状态（编辑和新增两种状态）
          addSrc:"/fmsBizCaseInfo/add",//添加地址
